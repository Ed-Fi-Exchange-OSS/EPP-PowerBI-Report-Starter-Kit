...
/****** Object:  View [analytics].[Survey]    Script Date: 12/21/2020 1:04:44 PM ******/
SET ANSI_NULLS ON
GO
...
IF OBJECT_ID('[analytics].[Survey]') IS NOT NULL
	DROP VIEW [analytics].[Survey]

GO

CREATE VIEW [analytics].[Survey] AS
