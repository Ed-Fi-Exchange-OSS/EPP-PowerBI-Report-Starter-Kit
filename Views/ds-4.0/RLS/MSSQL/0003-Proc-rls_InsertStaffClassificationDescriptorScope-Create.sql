...
IF OBJECT_ID('analytics_config.rls_InsertStaffClassificationDescriptorScope') IS NOT NULL 
	DROP PROCEDURE analytics_config.rls_InsertStaffClassificationDescriptorScope
