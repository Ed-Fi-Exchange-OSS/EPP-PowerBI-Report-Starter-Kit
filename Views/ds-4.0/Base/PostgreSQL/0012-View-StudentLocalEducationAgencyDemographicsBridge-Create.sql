...
AS
    WITH StudentLocalEducationAgencyDemographics
         AS (SELECT
             ...
             LEFT JOIN
                 edfi.studenteducationorganizationassociationstudentcharacteri_a18fcf ON
                     ...
                     AND
                     studenteducationorganizationassociationstudentcharacteri_a18fcf.StudentUSI = StudentEducationOrganizationAssociationStudentCharacteristic.StudentUSI
                     AND
                     studenteducationorganizationassociationstudentcharacteri_a18fcf.StudentCharacteristicDescriptorId = StudentEducationOrganizationAssociationStudentCharacteristic.StudentCharacteristicDescriptorId
             INNER JOIN
                 edfi.Student ON
                     Student.StudentUsi = StudentEducationOrganizationAssociation.StudentUSI
             INNER JOIN
